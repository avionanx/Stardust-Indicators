...
public class Main {
  ...
  private final int maxFrames = 24;
  ...
  public void render(final RenderEvent event) {
    if(currentEngineState_8004dd04 instanceof SMap && !SCRIPTS.isPaused()) {
      this.transforms.forEach(transform -> {
        ...
        this.stardustIndicator.render(cacheMV, this.currentFrame, this.maxFrames);
      });
  ...
  private final Map<Integer, StardustInfoStruct[]> stardustData = Map.<Integer, StardustInfoStruct[]>ofEntries(
          ...
          Map.entry(211, new StardustInfoStruct[]{new StardustInfoStruct(0x1d9, 0xffffffa0, 0x0, 0xffffff74)}),
          ...
          Map.entry(222, new StardustInfoStruct[]{new StardustInfoStruct(0x1dc, 0x140, 0xffffffce, 0xfb)}),
          ...
          Map.entry(516, new StardustInfoStruct[]{new StardustInfoStruct(0x1f1, 0x0, 0x0, 0x0), new StardustInfoStruct(0x1f1, 0x0, 0xffffffce, 0x0)}),
          ...
          Map.entry(523, new StardustInfoStruct[]{new StardustInfoStruct(0x1f2, 0x0, 0x0, 0x0), new StardustInfoStruct(0x1f2, 0x0, 0xffffffe2, 0x0)}),
          Map.entry(525, new StardustInfoStruct[]{new StardustInfoStruct(0x1f3, 0xfffffff7, 0x50, 0xde), new StardustInfoStruct(0x1f3, 0x4f, 0x50, 0x82)}),
